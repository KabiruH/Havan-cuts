...
const Appointment = (props) => {
    ...
    const makeAppointment = async () => {
        ...
        let response = await axios.post('https://the-barber.onrender.com/appointment', appointmentData)
        let { error } = response.data
        if (error) {
            setError(error)
            setTimeout(() => {
            ...
            <div className='appointment-container'>
                <div className='appointment-form'>
                    ...
                    <div className='appointment-inner-container'>
                        ...
                        <div className='appointment-inner-container'>
                            <p>Your Name:<span className='red-astrix'>*</span></p>
                        ...
                        <div id='appo-phone' className='appointment-inner-container'>
                            <p>Phone: <span className='red-astrix'>*</span></p>
                            <input type="tel" className='phone-input' placeholder=''
                                value={phone}
